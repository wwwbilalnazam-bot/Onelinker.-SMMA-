...
CREATE INDEX IF NOT EXISTS idx_inbox_messages_workspace_received ON inbox_messages(workspace_id, received_at DESC);
...
BEGIN
  ...
  IF NOT EXISTS (
    ...
    WHERE schemaname = 'public'
      AND tablename = 'inbox_messages'
      AND policyname = 'Service role can insert inbox_messages'
  ) THEN
  ...
  IF NOT EXISTS (
    ...
    WHERE schemaname = 'public'
      AND tablename = 'inbox_messages'
      AND policyname = 'Service role can update inbox_messages'
  ) THEN
    CREATE POLICY "Service role can update inbox_messages"
  ...
  IF NOT EXISTS (
    ...
    WHERE schemaname = 'public'
      AND tablename = 'inbox_messages'
      AND policyname = 'Service role can delete inbox_messages'
  ) THEN
